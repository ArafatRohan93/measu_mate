...
import 'package:measu_mate/features/consultant/presentation/pages/consultants_screen.dart';
...
import '../../../consultant/presentation/bloc/consultant_details_bloc/consultant_details_bloc.dart';
import '../../../../features/consultant/presentation/pages/consultant_details_screen.dart';
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Expanded(
                            child: Text(
                              context.l10n.availableSpecialists,
                          ...
                          TextButton(
                            onPressed: () {
                              Navigator.of(context).push(
                                MaterialPageRoute(
                                  builder: (_) => const ConsultantsScreen(),
                                ),
                              );
                            },
                            child: Text(
                                    ...
                                    Navigator.of(context).push(
                                      MaterialPageRoute(
                                        builder: (_) => BlocProvider(
                                          create: (context) =>
                                              ConsultantDetailsBloc(sl())
                                                ..add(FetchConsultantDetails(
                                                    specialist.name)),
                                          child: ConsultantDetailsScreen(
                                              consultantId: specialist.name),
                                        ),
                                      ),
                                    );
                                  },
...
class _HomeSliverAppBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SliverAppBar(
      ...
      floating: false,
      snap: false,
      surfaceTintColor: AppColors.yellowCream,
      backgroundColor: AppColors.white,
      elevation: 0,
            ...
            children: [
              IconButton(
                icon: const Icon(Icons.menu,
                    size: 28, color: AppColors.blackBlueDark),
                onPressed: () {
              ...
              Text(context.l10n.hi('Yousuf'),
                  style: AppTextStyles.h4Bold
                      .copyWith(color: AppColors.blackBlueDark)),
              const Spacer(),
              const Icon(Icons.star, color: AppColors.orange, size: 26),
